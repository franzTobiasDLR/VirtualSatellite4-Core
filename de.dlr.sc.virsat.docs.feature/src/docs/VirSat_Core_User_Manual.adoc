...
The REST API can be used to access and manipluate the Virtual Satellite model without the user interface.
...
=== The REST API for Users

Description of the reposiories api and levels (with an example request).

=== The REST Server for Administrators

Description of the server lifecycle (startup and shutdown).

Example server configuration file. 

LDAP and HTTPS.

Description of the admin resource.
